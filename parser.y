...
id_label: TK_IDENTIFICADOR;      {$$ = nullptr; delete $1;}
name_func: TK_IDENTIFICADOR;     {$$ = nullptr; delete $1;}
id_param: type TK_IDENTIFICADOR; {$$ = nullptr; delete $1; delete $2};
